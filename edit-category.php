...
$sql="UPDATE `tblcategory` SET `CategoryName`=:category, `Status`=:status WHERE C_id=:catid";
...
<head>
    ...
    <title>Sapthagiri College of Engg. CSE Library | Edit Categories</title>
...
<?php 
$catid=intval($_GET['catid']);
$sql="SELECT * from tblcategory where C_id=:catid";
$query=$dbh->prepare($sql);
$query-> bindParam(':catid',$catid, PDO::PARAM_STR);
$query->execute();
